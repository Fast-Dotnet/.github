...
[Website](http://fastdotnet.com) · [Documentation](http://docs.fastdotnet.cn/en-US) · [Fast.NET](https://github.com/China-xiaoFang/Fast.NET) · [Fast.Admin](https://github.com/China-xiaoFang/Fast.Admin)
...
#### [Fast.NET](https://github.com/China-xiaoFang/Fast.NET)
...
| Project | Description |
| --- | --- |
| [Fast.Element.Plus](https://github.com/China-xiaoFang/Fast.Element.Plus) | Business component SDK for Vue 3 and Element Plus, including tables, forms, selectors, dialogs, directives, and composables |
| [Fast.Element.Plus.Icons](https://github.com/China-xiaoFang/Fast.Element.Plus.Icons) | SVG icon components for Vue 3 with named imports, type support, and reviewable source generation |
...
| Project | Description |
| --- | --- |
| [Fast.Axios](https://github.com/China-xiaoFang/Fast.Axios) | Axios-based SDK with Fast.NET response handling, application extension points, and uni-app adaptation |
| [Fast.Utils](https://github.com/China-xiaoFang/Fast.Utils) | TypeScript utilities for browsers, WebViews, Vue 3, and uni-app, including storage, async, and data helpers |
| [Fast.Vite.Plugins](https://github.com/China-xiaoFang/Fast.Vite.Plugins) | Vite plugins for Web projects, covering code generation, asset processing, build metadata, and release checks |
| [Fast.ESLint.Config](https://github.com/China-xiaoFang/Fast.ESLint.Config) | Typed ESLint Flat Config for Vue 3, uni-app, and TypeScript, with composable configurations and rule documentation |
| [Fast.ESLint.Config.Legacy](https://github.com/China-xiaoFang/Fast.ESLint.Config.Legacy) | Legacy ESLint 8 configuration with composable Vue, TypeScript, and related tooling support |

### Administration System

#### [Fast.Admin](https://github.com/China-xiaoFang/Fast.Admin)
...
- GitHub provides synchronized public mirrors and English project entry points under [China-xiaoFang](https://github.com/China-xiaoFang)
...
| GitHub mirrors | [China-xiaoFang](https://github.com/China-xiaoFang) |
